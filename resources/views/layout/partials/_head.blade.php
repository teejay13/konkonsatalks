...
<!--
    ...
    <meta charset="utf-8" />
    <title>Konkonsa Talks @yield('title')</title>
    ...
    <link rel="stylesheet" media="screen" type="text/css" href="{{URL::asset('plugins/pace/pace-theme-flash.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{URL::asset('plugins/perfect-scrollbar/perfect-scrollbar.css')}}">
